...
<head>
    ...
    display: flex;
    flex-direction: row; /* Барлық элементтерді көлденең орналастыру */
    justify-content: flex-start; /* Сол жақтан бастау */
    align-items: center;
    min-height: 100vh; /* Бүкіл экран биіктігін алу */
...
.container {
    max-width: 63%; /* Контейнер енін азайту */
    margin-left: auto; /* Контейнерді оң жаққа ығыстыру */
    padding: 40px;
    background-color: rgba(0, 0, 0, 0.7); /* Қараңғырақ фон */
    border-radius: 8px;
...
<body>
    <div class="container">
     ...
     <audio id="backgroundMusic" loop autoplay>
        <source src="бірінші.m4a"audio>
    </audio>
    <script>
      // Запуск музыки при взаимодействии с пользователем (требование браузеров)
        ...
        window.onload = function() {
            const audio = document.querySelector('audio');
            audio.volume = 0.9; // Устанавливаем громкость на 0%
            audio.play().catch(e => console.log("Автовоспроизведение заблокировано"));
        };
